            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <li><a href="{{ route('home') }}">Home</a></li>
                        <li><a href="{{ route('manager.borrow_requests') }}" class="active">Borrow Requests</a></li>
...
<div class="alert alert-success">
  ...
  @endforeach
        ...
        <p style="padding-right:10px;">{{ $request->reader->name }} wants to borrow {{ $request->book->title }} by {{ $request->book->author}}</p>
        <form action="{{ route('manager.confirm_borrow', $request->id) }}" method="POST" style="padding-right:10px;">
            @csrf
